...
DefNode( ShaderNode,     SH_NODE_TEX_CURVE,          def_sh_tex_curve,       "TEX_CURVE",          TexCurve,         "Curve Texture",     ""       )
...
DefNode( ShaderNode,     SH_NODE_AOV_OUTPUT,         def_sh_aov_output,      "AOV_OUTPUT",         AOVOutput,        "AOV Output",        ""       )
...
DefNode( CompositorNode, CMP_NODE_MULTIMIX,       def_cmp_multimix,		  "MULTI_MIX",		MultiMix,		  "Multi Mix",		   ""			   )
