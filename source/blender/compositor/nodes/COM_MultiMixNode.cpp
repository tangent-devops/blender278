...
*		Jeroen Bakker
*		Monique Dewanchand
*		Cristian Kovacs (Just the multi mix node)
*/
...
MultiMixNode::MultiMixNode(bNode *editorNode) : Node(editorNode)
{
	/* pass */
}

void MultiMixNode::convertToOperations(NodeConverter &converter, const CompositorContext &/*context*/) const
{
	...
	MultiMixOperation *prog = new MultiMixOperation(getNumberOfInputSockets());
